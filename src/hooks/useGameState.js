...
export const useGameState = () => {
  ...
  // Підписуємося на кожен шматочок окремо
  ...
  const handleSquareClick = useCallback(
    (squareId) => {
      // Якщо нічого не вибрано і ми тиснули на фігуру — вибираємо її
      if (!selectedSquare && board[squareId]) {
        dispatch(setSelection(squareId));
      }
      // Якщо фігура вже вибрана — намагаємося зробити хід через Operations
  ...
  // Повертаємо об'єкт для HomePage та Контейнерів
  return {
    gameState: {
